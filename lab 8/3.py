...
def main():
    ...
    clear_png = pygame.transform.scale(pygame.image.load("clear.jpg"), (30, 30))
    save_png = pygame.transform.scale(pygame.image.load("save.jpg"), (98, 50))
    ...
    def size_buttons():
        ...
        sz_btn = pygame.transform.scale(pygame.image.load("up_down.jpg"), (25, 25))
